-- Tutorial 11: produce the independent 1M daily dashboard from DWS.

USE ecommerce_ads;

CREATE EXTERNAL TABLE IF NOT EXISTS daily_behavior_dashboard_1m (
  event_count       BIGINT,
  active_users      BIGINT,
  active_items      BIGINT,
...
STORED AS ORC
LOCATION '/warehouse/ecommerce/ads/daily_behavior_dashboard_1m'
TBLPROPERTIES ('external.table.purge'='false');

SET hive.exec.dynamic.partition=true;
SET hive.exec.dynamic.partition.mode=nonstrict;

ALTER TABLE daily_behavior_dashboard_1m DROP IF EXISTS PARTITION (dt='2017-11-24');

INSERT OVERWRITE TABLE daily_behavior_dashboard_1m PARTITION (dt)
SELECT
  event_count,
  active_users,
  active_items,
